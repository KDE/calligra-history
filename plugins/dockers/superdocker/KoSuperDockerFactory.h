...
#ifndef KOSUPERDOCKERFACTORY_H
#define KOSUPERDOCKERFACTORY_H

#include <QtGui/QDockWidget>
#include "KoDockFactory.h"

/// the factory which creates the shape properties docker
class KoSuperDockerFactory : public KoDockFactory
{
public:
    KoSuperDockerFactory();
